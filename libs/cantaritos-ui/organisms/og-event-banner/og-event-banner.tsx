...
export function OgEventBanner() {
  return (
    <section className="w-full max-w-[1443px] mx-auto min-h-[588px] lg:h-[872px] bg-[url('/images/vector.png')] bg-top bg-no-repeat bg-cover mt-[50px] md:mt-0">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
          ...
          <div className="order-3 md:order-1 flex-1 space-y-6">
            ...
            <p className="text-[#1E293B] font-body font-medium text-sm md:text-[24px] md:leading-snug max-w-[380px] md:max-w-[480px] text-center md:text-left">
              Lleva el Cantarito Gigante y el mood
              <br />
              cantaristico a tu fiesta, boda o evento
              <br />
              empresarial.
            </p>
