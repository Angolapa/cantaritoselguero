...
export function MlSizeRow({
  ...
  const [descriptionEs, setDescriptionEs] = useState(size?.descriptionEs ?? "");
  const [descriptionEn, setDescriptionEn] = useState(size?.descriptionEn ?? "");
    ...
    <div className="space-y-2 rounded-lg border border-gray-200 bg-gray-50 p-4">
      ...
      <div className="flex items-center gap-4 pl-9">
        <div className="flex-1">
          <AtInput
            size="sm"
            placeholder="Descripcion (ES) - Ej: 500ml"
            value={descriptionEs}
            onValueChange={setDescriptionEs}
            isDisabled={isLoading}
          />
        </div>
        <div className="flex-1">
          <AtInput
            size="sm"
            placeholder="Description (EN) - E.g: 500ml"
            value={descriptionEn}
